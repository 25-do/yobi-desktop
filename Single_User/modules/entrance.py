...
################################################################################
## Form generated from reading UI file 'ashoEWyrd.ui'
##
...
"}")
        icon = QIcon()
        icon.addFile(u":/images/images/images/hr.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon1 = QIcon()
        icon1.addFile(u":/images/images/images/accounting.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon2 = QIcon()
        icon2.addFile(u":/images/images/images/crm (1).png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        icon3 = QIcon()
        icon3.addFile(u":/images/images/images/user.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        brush2 = QBrush(QColor(184, 184, 184, 255))
        brush2.setStyle(Qt.SolidPattern)
        palette.setBrush(QPalette.Active, QPalette.Text, brush2)
        brush3 = QBrush(QColor(203, 203, 203, 255))
...
"}")
        icon4 = QIcon()
        icon4.addFile(u":/images/images/images/payment-terminal.png", QSize(), QIcon.Normal, QIcon.Off)
