...
def stats_database(self):
    ...
    cusr.execute("CREATE TABLE IF NOT EXISTS purchase_order_items(po_items_id INTEGER PRIMARY KEY AUTOINCREMENT, created TIMESTAMP, updated TIMESTAMP, uuid TEXT, bill_uuid TEXT, purchase_order_uuid TEXT, name TEXT, cogs INTEGER, quantity INTEGER, amount INTEGER, user_uuid TEXT)")
