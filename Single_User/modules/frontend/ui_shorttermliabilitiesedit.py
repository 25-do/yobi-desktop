...
################################################################################
## Form generated from reading UI file 'shorttermliabilitieseditEthuwW.ui'
##
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">Short term liabilities</span></p></body></html>", None))
