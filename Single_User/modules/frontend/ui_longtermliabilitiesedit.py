...
################################################################################
## Form generated from reading UI file 'longtermliabilitiesedituaFkjb.ui'
##
...
"")
        ...
        self.label_2.setMaximumSize(QSize(16777215, 34))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(QCoreApplication.translate("Dialog", u"liability", None))
        self.label_2.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">Long term liabilities</span></p></body></html>", None))
