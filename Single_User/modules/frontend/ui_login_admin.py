...
################################################################################
## Form generated from reading UI file 'login_adminAbbyvK.ui'
##
...
"}")
    ...
    def retranslateUi(self, Login):
        ...
        self.user_description.setText(QCoreApplication.translate("Login", u"<html><head/><body><p align=\"center\"><span style=\" font-size:24pt; color:#ffffff;\">Admin</span></p></body></html>", None))
