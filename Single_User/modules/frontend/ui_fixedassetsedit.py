...
################################################################################
## Form generated from reading UI file 'fixedassetseditxEtWVm.ui'
##
...
class Ui_Dialog2(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setMinimumSize(QSize(525, 300))
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">Fixed assets</span></p></body></html>", None))
