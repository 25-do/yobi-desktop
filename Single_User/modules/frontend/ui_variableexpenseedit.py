...
################################################################################
## Form generated from reading UI file 'variableexpenseeditIGyPut.ui'
##
...
class Ui_Dialog6(object):
    def setupUi(self, Dialog):
        ...
        icon = QIcon()
        icon.addFile(u"../.designer/backup/logo14.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(QCoreApplication.translate("Dialog", u"<html><head/><body><p><span style=\" font-size:18pt; font-weight:600; color:#ffffff;\">Variable expense</span></p></body></html>", None))
